...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, id: string, title: string, slug: string, lessonType: LessonType }> };
